...
(setq xgtags-mode-map
      (let ((keymap (make-sparse-keymap))
        ...
        (define-key keymap "\C-xa" sub-keymap)
     ...
     (lambda (dir)
       ...
       (let ((xgtags-rootdir (and dir (file-name-as-directory dir))))
         (with-xgtags-environment
          ...
          ;; (print (xgtags--option-string option))
          ;; (print (xgtags--list-sans-nil
          ;;                      "--cxref"
...
(defun xgtags-visit-rootdir-ex (gtags-id)
  "where searches for the gtags database directory should begin.  This
overrides the current directory, which would otherwise be used."
  (interactive "Dgtags Initial Directory: ")
  ;; (setq xgtags-rootdir gtags-id)
