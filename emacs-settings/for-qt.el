...
(defun jk/c-mode-common-hook ()
 ...
 Includes support for Qt code (signal, slots and alikes)."
   ...
   (progn
     ...
     ;; (make-face 'qt-macro-keywords-face)
     ;; (set-face-foreground 'qt-macro-keywords-face "Red")
     ...
     (font-lock-add-keywords 'c++-mode
                             '(("\\<Q[A-Z][A-Za-z_]*\\>" . 'qt-keywords-face)))

     ;; (font-lock-add-keywords 'c++-mode
     ;;                         '(("\\<Q[A-Z][A-Za-z]*" . 'qt-keywords-face)))

     ;; (font-lock-add-keywords 'c++-mode
     ;;                         '(("\\<Q[A-Z]_[A-Z_]*" . 'qt-macro-keywords-face)))

     ))
 (add-hook 'c-mode-common-hook 'jk/c-mode-common-hook)
 ;; (remove-hook 'c-mode-common-hook 'jk/c-mode-common-hook)
