...
(defun color-theme-jsc-light ()
  ...
  (color-theme-install
   '(color-theme-jsc-light
    ...
    (highlight ((t (:background "antiquewhite" ))))
    (italic ((t (:italic t))))
    (makefile-space-face ((t (:background "hotpink"))))
    (message-cited-text-face ((t (:foreground "red"))))
    (message-header-cc-face ((t (:foreground "MidnightBlue"))))
...
;    (highlight ((t (:background "darkslategray" :foreground "wheat"))))
    ;; (highlight ((t (:background "darkslategray" :underline t :italic t))))
    ;; (highlight ((t ( :background "darkslategray" :underline t :italic t :bold t))))
    (highlight ((t (:background "darkslategray" :underline nil  :bold nil :italic nil))))
    (highlight-changes-delete-face ((t (:underline t :foreground "red"))))
    (highlight-changes-face ((t (:foreground "red"))))
;    (highline-face ((t (:background "gray35"))))
...
This builds on `color-theme-jsc-light'."
  ...
  (let ((color-theme-is-cumulative t))
	...
	(senator-eldoc-use-color . t))
       ...
       ; (highlight ((t (:background "darkseagreen2"))))
   ;; (highlight ((t (:background "darkseagreen2" :underline nil  :italic t :bold t ))))       
   ;; (highlight ((t (:background "red" :underline nil  :italic t :bold t ))))       
     ;; (highlight-changes-face ((t (:background "red"))))
     ;; (highline-face ((t (:background "red"))))
     ( hl-line ((t (:background "#d3d3d3"))))
...
(defun color-theme-galen ()  
  ...
  (color-theme-install  
   '(color-theme-galen  
     ((background-color . "Grey4") ; Grey4 let line number's color is chocolate  
      (background-mode . light)  
      (border-color . "black")  
      (cursor-color . "#000000")  
      (foreground-color . "#000000")  
     ...
     (default ((t (:stipple nil :background "#ffffff" :foreground "#000000" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 87 :width semi-condensed :family "misc-fixed"))))  
     (font-lock-builtin-face ((t (:foreground "chocolate1")))); to use for builtins  
     (font-lock-comment-face ((t (:foreground "red")))); *** to use for comments  
     (font-lock-constant-face ((t (:foreground "OrangeRed")))); *** to use for constant and label names (class::)  
     (font-lock-doc-face ((t (:foreground "red"))));to use for documentation. such as /* this is ducumentation */  
     (font-lock-doc-string-face ((t (:foreground "red"))));  
     (font-lock-function-name-face ((t (:foreground "blue" :underline t)))) ; *** to use for function names  
     (font-lock-preprocessor-face ((t (:foreground "chocolate1")))); *** to use for preprocessor directives  
     (font-lock-keyword-face ((t (:foreground "blue4")))); *** to use for keywords  
     (font-lock-reference-face ((t (:foreground "pale green"))));  
     (font-lock-string-face ((t (:foreground "red")))); *** to use for strings "Hello, World"  
     (font-lock-type-face ((t (:foreground "blue4" )))); *** to use for type and class names  
     (font-lock-variable-name-face ((t (:foreground "red")))); *** to use for variable names  
     (font-lock-warning-face ((t (:foreground "Red"))));to use for things that should stand out.  
     (font-lock-negation-char-face ((t (:foreground "OrangeRed"))));to use for easy to overlook negation   
     (font-lock-exit-face ((t (:foreground "green"))));  
     (font-lock-emphasized-face ((t (:background "lightyellow2"))))  
     (font-lock-other-emphasized-face ((t (:background "lightyellow2"))))  
     (font-lock-other-type-face ((t (:foreground "orange3"))))  
     (font-lock-special-comment-face ((t (:foreground "blue"))))  
     (font-lock-special-keyword-face ((t (:foreground "blue"))))  
     (region ((t (:background "steel blue" :foreground "black")))) ; region  
     (highlight ((t (:background "sky blue")))) ; highlight current line  
      
     (modeline-buffer-id ((t (:foreground "black" :background "wheat"))));the filename on modeline(yellow)  
