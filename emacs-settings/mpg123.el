...
(defvar mpg123-file-name-coding-system
  (cond
   ...
   ((coding-system-p 'chinese-gbk-unix) 'chinese-gbk-unix)
   ((coding-system-p '*euc-japan*) '*euc-japan*))
  "*Default file name coding system for encoding music files.")


(setq mpg123-file-name-coding-system 'chinese-gbk)
...
;; (defun mpg123:get-command-name (file) 
;;   (setq cmd-name (mpg123:get-from-file-about file "command")) 
;;   (if (not cmd-name) (setq cmd-name "mpg123")) 
;;   cmd-name) 
