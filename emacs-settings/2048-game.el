...
(define-derived-mode 2048-mode special-mode "2048-mode"
  (define-key 2048-mode-map (kbd "w") '2048-up)
  (define-key 2048-mode-map (kbd "s") '2048-down)
  (define-key 2048-mode-map (kbd "a") '2048-left)
  (define-key 2048-mode-map (kbd "d") '2048-right)
...
(defun 2048-right ()
  ...
  ;; (global-set-key (kbd "w") '2048-up)
  ;; (global-set-key  (kbd "s") '2048-down)
  ;; (global-set-key  (kbd "a") '2048-left)
  ;; (global-set-key  (kbd "d") '2048-right)
