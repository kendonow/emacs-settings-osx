...
;; (defvar workspace-dir "~/emacs-setting/")
(setq workspace-dir "~/qt_project/06-hmi/")
...
(defun ifind-set-dir (ifind-id)
  (interactive "Difind Directory: ")

  (setq workspace-dir ifind-id)
 (setq ifind-dir ifind-id)
)
